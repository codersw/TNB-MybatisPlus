package com.mango.demand.pool.aspect;

import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.mango.demand.pool.utils.CommonUtils;
import com.mango.demand.pool.constant.MdcConstant;
...
public class ControllerAspect {
    ...
    @Pointcut("execution(public * com.mango.demand.pool.controller.*.*(..)) || target(com.mango.demand.pool.handler.GlobalExceptionHandler)))")
    public void webLog() {}
