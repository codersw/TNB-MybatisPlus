...
INSERT INTO `t_menu`(`menu_id`, `parent_id`, `menu_name`, `path`, `component`, `perms`, `icon`, `type`, `order_num`, `create_time`, `modify_time`, `is_del`) VALUES (21, 0, '需求管理', '', '', 'require:admin:view', '', 0, 6, '2020-02-25 15:56:38', '2020-02-25 15:56:38', 0);
